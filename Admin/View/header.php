...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="/LynxCMS/Admin/Assets/css/bootstrap.min.css" rel="stylesheet">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="/lynxcms/admin/">
                            <i class="icon-speedometer icons"></i> Home
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/lynxcms/admin/pages/">
                            <i class="icon-doc icons"></i> Pages
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="/lynxcms/admin/settings/general/">
                            <i class="icon-equalizer icons"></i> Settings
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="/lynxcms/admin/plagins/">
